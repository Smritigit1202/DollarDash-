...
from cModels.serializers import MyTokenObtainPairSerializer, MyTokenRefreshSerializer
from cModels.models import HubUser, Transaction
from rest_framework.response import Response
from rest_framework.decorators import api_view, permission_classes
from rest_framework.views import APIView
from rest_framework.permissions import IsAuthenticated
from rest_framework.parsers import FileUploadParser
from cModels.serializers import SavingPlanSerializer, WalletSerializer, TransactionSerializer
from rest_framework_simplejwt.tokens import RefreshToken
from rest_framework_simplejwt.views import TokenObtainPairView, TokenRefreshView
from datetime import date
from datetime import timedelta
from cModels.models import CustomLabel
from cModels.serializers import LabelSerializer
from cModels.importer import PDFInvoiceImporter, InvoiceProcessingException
...
class ImportInvoicesAPIView(APIView):
    ...
    def post(self, request):
        ...
        file_path = 'api/imported_files/buffer.pdf'
