...
class PDFInvoiceImporter:
    def __init__(self, file_path, institution):
        ...
        if institution == 'Bank':
            self.processor = BankInvoiceProcessor

        elif institution == 'Banco do Brasil':
            self.processor = BancoDoBrasilInvoiceProcessor

        elif institution == 'Cash':
            self.processor = CashInvoiceProcessor
...
class BankInvoiceProcessor(InvoiceProcessor):
...
class CashInvoiceProcessor(InvoiceProcessor):
    def generate_dict(self, text, invoice_dict):
        # TODO: Implement Cash importing routine
        raise NotImplementedError()
