// ✅ Updated: NewTransactionForm.tsx
...
function NewTransactionForm() {
  ...
  return (
    <form
      ...
      style={{ display: "flex", flexDirection: "column", gap: 20, width: "500px", marginTop: 20 }}
    >
      <Controller
        name="title"
        control={control}
      ...
      <Controller
        ...
        render={({ field: { onChange, value, name } }) => (
          <FormControl>
            <FormLabel sx={{ mb: 1, "&.Mui-disabled": { color: "white" } }} disabled={true}>
              Type
            </FormLabel>
            <RadioGroup
            ...
            >
              {Object.values(TypeOption).map((item, i) => (
                <FormControlLabel
                  ...
                  sx={{ backgroundColor: grey[900], p: 1, m: 0.5, borderRadius: 2 }}
                />
              ))}
            </RadioGroup>
          </FormControl>
